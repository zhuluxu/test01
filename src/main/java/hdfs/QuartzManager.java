...
public class QuartzManager {
    ...
    public void standByJon(String jobName, String jobGroupName) {
        try {
            JobKey jobKey = JobKey.jobKey(jobName, jobGroupName);

            scheduler.pauseJob(jobKey);// 停止当前Job

            System.out.println(jobName + " : 已经暂停！");
    ...
    public void recoverJon(String jobName, String jobGroupName) {
        try {
            JobKey jobKey = JobKey.jobKey(jobName, jobGroupName);

            scheduler.resumeJob(jobKey);// 停止当前Job

            System.out.println(jobName + " : 恢复运行！");
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
